...
/***/ (function(module, exports, __webpack_require__) {
    ...
    function animation() {
      ...
      var wrapCharSpan = function wrapCharSpan(str) {
      ...
      var slideup = document.querySelectorAll('.j-slideup'); // const typeTarget = document.querySelectorAll('.typeing');
    ...
    function header() {
      ...
      if (header) {
        ...
        var bgWhite = document.querySelectorAll('.js-bgWhite');
        window.addEventListener('scroll', function () {
          bgWhite.forEach(function (section) {
    ...
    Object(_modules_animation__WEBPACK_IMPORTED_MODULE_1__["animation"])(); // stalker();
