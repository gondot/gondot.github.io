  ...
  */
  ...
  (function (global, factory) {
    ...
    function updateProgress(translate) {
      ...
      if (params.loop) {
        var firstSlideIndex = swiper.getSlideIndex(swiper.slides.filter(function (el) {
          return el.getAttribute('data-swiper-slide-index') === '0';
        })[0]);
        var lastSlideIndex = swiper.getSlideIndex(swiper.slides.filter(function (el) {
    ...
    function slideToLoop(index, speed, runCallbacks, internal) {
      ...
      if (swiper.params.loop) {
        if (swiper.virtual && swiper.params.virtual.enabled) {
          ...
          newIndex = swiper.getSlideIndex(swiper.slides.filter(function (slideEl) {
    ...
    function HashNavigation(_ref) {
      ...
      var onHashChange = function onHashChange() {
        ...
        if (newHash !== activeSlideHash) {
          var newIndex = swiper.getSlideIndex(elementChildren(swiper.slidesEl, ".".concat(swiper.params.slideClass, "[data-hash=\"").concat(newHash, "\"], swiper-slide[data-hash=\"").concat(newHash, "\"]"))[0]);
      ...
      var setHash = function setHash() {
        ...
        if (swiper.params.hashNavigation.replaceState && window.history && window.history.replaceState) {
          window.history.replaceState(null, null, "#".concat(swiper.slides[swiper.activeIndex].getAttribute('data-hash')) || false);
          emit('hashSet');
        } else {
      ...
      var init = function init() {
        ...
        if (hash) {
          ...
          for (var i = 0, length = swiper.slides.length; i < length; i += 1) {
            ...
            if (slideHash === hash) {
              var index = swiper.getSlideIndex(_slide6);
  ...
  /* harmony import */ var _modules_mv__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mv */ "./src/assets/js/modules/mv.js");
  /* harmony import */ var _modules_time__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/time */ "./src/assets/js/modules/time.js");
  /* harmony import */ var _modules_dragscroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/dragscroll */ "./src/assets/js/modules/dragscroll.js");
  
  
  
  
  Object(_modules_loading__WEBPACK_IMPORTED_MODULE_0__["loading"])();
  Object(_modules_mv__WEBPACK_IMPORTED_MODULE_1__["mv"])();
  Object(_modules_time__WEBPACK_IMPORTED_MODULE_2__["time"])();
  Object(_modules_dragscroll__WEBPACK_IMPORTED_MODULE_3__["dragscroll"])();
  Object(_modules_dragscroll__WEBPACK_IMPORTED_MODULE_3__["dragscroll"])();
  
  /***/ }),
  
  /***/ "./src/assets/js/modules/dragscroll.js":
  /*!*********************************************!*\
    !*** ./src/assets/js/modules/dragscroll.js ***!
    \*********************************************/
  ...
  function dragscroll() {
    var targets = document.querySelectorAll(".js-dragscroll");
    var target;
    ...
    document.addEventListener("mousemove", function (event) {
      if (target && target.dataset.down) {
        event.preventDefault();
        var move_x = target.dataset.x - event.clientX;
  ...
  function loading() {
    ...
    /* ãƒ­ãƒ¼ãƒ‰ç”»é¢ã‚’éžè¡¨ç¤ºã«ã™ã‚‹å‡¦ç† */
    ...
    /* 10ç§’çµŒã£ãŸã‚‰å¼·åˆ¶çš„ã«ãƒ­ãƒ¼ãƒ‰ç”»é¢ã‚’éžè¡¨ç¤ºã«ã™ã‚‹ */
    // setTimeout('stopload()', 3000);
  }
  
  /***/ }),
  
  /***/ "./src/assets/js/modules/mv.js":
  /*!*************************************!*\
    !*** ./src/assets/js/modules/mv.js ***!
    \*************************************/
  /*! exports provided: mv */
  ...
  function mv() {
    var mySwiper = new swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0___default.a('.j-mvSlider', {
      speed: 1000,
      spaceBetween: 0,
      effect: "fade",
    ...
    window.addEventListener("load", function () {
      ...
      var mvEl = document.querySelector('.j-mv');
      gsap__WEBPACK_IMPORTED_MODULE_1__["gsap"].to(mvEl, {
        ease: 'none',
        scrollTrigger: {
          // markers: true,
          trigger: mvEl,
  ...
  function time() {
    ...
    var displayTime = function displayTime() {
      // // æ™‚åˆ»ã‚’è¡¨ç¤ºã™ã‚‹è¦ç´ ã‚’å–å¾—
      var clock = document.querySelector('.js-time');
      var nowTime = new Date();
      var nowHour = twoDigit(nowTime.getHours());
      var nowMin = twoDigit(nowTime.getMinutes());
      var nowSec = twoDigit(nowTime.getSeconds());
      var msg = "" + nowHour + " : " + nowMin + " : " + nowSec; // è¦ç´ ã«æ™‚åˆ»ã‚’è¡¨ç¤º
  
      clock.innerText = msg;
    };
  
    displayTime(); // 1ç§’ã”ã¨ã«displayTimeé–¢æ•°ã‚’å‘¼ã³å‡ºã™
